...
//     func AmountGreaterThan1000(db *zdpgo_orm.DB) *zdpgo_orm.DB {
//         return db.Where("amount > ?", 1000)
//     }
//
//     func OrderStatus(status []string) func (db *zdpgo_orm.DB) *zdpgo_orm.DB {
//         return func (db *zdpgo_orm.DB) *zdpgo_orm.DB {
