...
// CreateTable z01_add table in database for values
...
// AddColumn z01_add `name` column for value
...
// CreateConstraint z01_add constraint
...
// CreateIndex z01_add index `name`
func (m Migrator) CreateIndex(value interface{}, name string) error {
	return m.RunWithValue(value, func(stmt *gorm.Statement) error {
		...
		return fmt.Errorf("failed to z01_add index with name %s", name)
	})
}
